...
Remove the aircraft-project dependency; extract reusable API helpers into a standalone root harness.
Retain measured lessons on units, API wiring, recipes, conic lofting, assemblies, rendering, and background dispatch.
Exclude unverified third-party reference notebooks, source photos and embedded copies, source meshes, private logs,
legacy model variants, old Git history, commercial binaries, and large generated outputs.

Plan:
1. Inventory core dependencies and select source, native models, reports, and useful lessons.
