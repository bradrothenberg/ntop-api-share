...
| Fury RC | Current finite-edge mesh evidence, earlier surface, alternatives, and CFD readiness |
| B52 | R2-R6 loft studies plus the R7 fair nose report |
| DDGX | Native concept exterior and hull-to-bulb correction |
| F-16 | R6 geometry plus Onshape and Fusion comparisons against earlier R3 |
