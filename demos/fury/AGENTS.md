...
- Build from the repository root with `uv run --locked python scripts/build.py fury`.
- Use `uv run --locked python scripts/stage.py fury` for a new empty nTop notebook.
