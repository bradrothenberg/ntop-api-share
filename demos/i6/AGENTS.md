...
- Build from the repository root with `uv run --locked python scripts/build.py i6`.
- Use `uv run --locked python scripts/stage.py i6` for a new empty nTop notebook.
