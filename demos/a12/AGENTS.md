...
- Use `uv run --locked python scripts/build.py a12` from the repository root to replay and check the graph.
- Use `uv run --locked python scripts/stage.py a12` to prepare an import for an empty nTop notebook.
